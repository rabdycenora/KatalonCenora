...
WebUI.setText(findTestObject('Flujo Completo/Page_NCL Live Experience/input_Search'), '15-Day South Pacific From Sydney To Papeete: Fiji, Moorea & Samoa', 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.dragAndDropByOffset(findTestObject('Flujo Completo - Copy/Page_NCL Live Experience/div_Card_origen - Copy'), 600, 
    200)

//WebUI.dragAndDropToObject(findTestObject('Flujo Completo - Copy/Page_NCL Live Experience/div_Card_origen - Copy'), findTestObject(
//      'Flujo Completo - Copy/Page_NCL Live Experience/div_Card_destin3'), FailureHandling.STOP_ON_FAILURE)
WebUI.switchToWindowIndex(1)
