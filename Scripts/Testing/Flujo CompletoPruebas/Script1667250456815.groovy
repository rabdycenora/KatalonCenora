...
WebUI.click(findTestObject('Flujo CompletoPruebasPruebas/Page_NCL Live Experience/div_CLick'))
...
WebUI.dragAndDropToObject(findTestObject('Flujo CompletoPruebas/Page_NCL Live Experience/div_Card_origen'), findTestObject('Flujo CompletoPruebas/Page_NCL Live Experience/div_Card_destin'), 
...
WebUI.dragAndDropByOffset(findTestObject('Flujo CompletoPruebas/Page_NCL Live Experience/div_Card_origen'), 400, 200)

WebUI.click(findTestObject('Flujo CompletoPruebas/Page_NCL Live Experience/div_Card_destin'))
